...
use crate::{
    ...
    operations::search::highlight::Highlight,
    units::JsonVal,
};

use super::{common::FieldBasedQuery, Flags, Fuzziness, MinimumShouldMatch, Query};
...
impl Query {
    ...
    where
        ...
        B: Into<JsonVal>,
    {
        MatchQuery(FieldBasedQuery::new(
            field.into(),
            MatchQueryInner {
                query: query.into(),
                ..Default::default()
...
impl Query {
    ...
    where
        A: Into<JsonVal>,
    {
        CommonQuery(FieldBasedQuery::new(
            "body".to_owned(),
            CommonQueryInner {
                query: query.into(),
                ..Default::default()
...
impl QueryStringQuery {
    ...
    add_field!(
        with_lowercase_expanded_terms,
        lowercase_expanded_terms,
        bool
    );
    add_field!(
        with_enable_position_increments,
    ...
    add_field!(
        with_auto_generate_phrase_queries,
